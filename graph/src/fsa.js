...
let start = initState(50, 50);
let user = state(30, 170, "user");
let state_1 = state(300, 170, "state 1");
let state_2 = state(165, 370, "state 2");

link(start, user, "start");
link(user, state_1, "go")
